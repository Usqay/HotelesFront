...
import { RoomPrice } from 'src/app/interfaces/room-price';
import { Currency } from 'src/app/interfaces/currency';
import { UserService } from 'src/app/services/user.service';
import { CurrenciesService } from 'src/app/services/currencies.service';
import { CurrencyRate } from 'src/app/interfaces/currency-rate';
...
export class RoomsCardListComponent implements OnInit {
  ...
  private getPaymentMethods(){
    this.alert.loading()
    this.getPaymentMethodsSubscription = this.paymentMethodsService.list(null, 1, 999)
    .subscribe(data => {
